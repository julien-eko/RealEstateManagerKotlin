...
class PropertyFragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        PushDownAnim.setPushDownAnimTo(nextToC).setScale(PushDownAnim.MODE_STATIC_DP, 5F)
            .setOnClickListener {
    ...
    private fun save(propertyActivity: PropertyActivity) {
        ...
        propertyActivity.numberOfBathrooms =
            edit_number_of_batthrooms_fragment_2.text.toString().toInt()
        propertyActivity.numberOfBedrooms =
            edit_number_of_bedrooms_fragment_2.text.toString().toInt()
        ...
        if (isUSD) {
            ...
            propertyActivity.price =
                Utils.convertEuroToDollar(edit_price_fragment_2.text.toString().toInt())
        }
    ...
    private fun validateForm(): Boolean {
        if (edit_number_of_romms_fragment_2.text.toString().trim() != "" &&
            ...
            if (edit_number_of_batthrooms_fragment_2.text.toString().trim() == "") {
                edit_number_of_batthrooms_fragment_2.error =
                    getString(R.string.field_cannot_be_blank)
            }
