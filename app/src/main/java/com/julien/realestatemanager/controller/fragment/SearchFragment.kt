...
class SearchFragment : DialogFragment(), DatePickerDialog.OnDateSetListener {
    ...
    private fun configureButtonDate(view: View) {
        ...
        PushDownAnim.setPushDownAnimTo(buttonSearch).setScale(PushDownAnim.MODE_STATIC_DP, 5F)
            .setOnClickListener {
        ...
        PushDownAnim.setPushDownAnimTo(buttonCancel).setScale(PushDownAnim.MODE_STATIC_DP, 5F)
            .setOnClickListener {
                dismiss()
            }
